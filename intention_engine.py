...
os.environ["COHERE_API_KEY"] = "dmdIbhN3Y36zhSXFIPv1g5PIJPiGD1zJ4X9xIP6q"
...
def handle_query():
    ...
    try:
        ...
        # logging.info(f"Final response : {responses}\n")
        # for response in responses:
        #     logging.info(f"Response from : {response}")
        return jsonify(intent_results), 200        
        # return jsonify(intent_results)
